      ...
      <div id="enteringRoom">
        <div className="w-100 d-flex flex-column justify-content-center p-2">
          ...
          <div className="input-group input-group-sm mb-3">
           <input type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="chatRoomName" onChange={prop.handleChange} value={prop.chatRoomName} maxLength={10}></input>
        </div>
